          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="heading-1">
                Find Your Perfect Auto Insurance Coverage
              </h1>
              <p className="subheading">
                Get comprehensive auto insurance coverage tailored to your needs. Compare quotes from top providers and save.
              </p>
              <div className="mt-8 flex items-center space-x-4">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-gray-600">24/7 Claims Support</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-6 h-6 text-[#00f5d4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="container-custom">
          <div className="max-w-2xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h2 className="text-2xl font-semibold mb-6 text-center">Get Your Auto Insurance Quote</h2>
